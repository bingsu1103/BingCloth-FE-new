        ...
        <div className='min-h-screen'>
            <div className='grid grid-cols-3 max-sm:grid-cols-1 max-xl:block max-xl:w-[60%] max-xl:m-auto max-sm:w-full p-8'>
                ...
                <div className='flex flex-col items-center border-2 rounded-2xl p-4 bg-[#fff]'>
                    <label className='font-bold text-2xl pt-8 text-[#000]' htmlFor="">Register</label>
                    <Form
                        name="basic"
                        labelCol={{ span: 6 }}
                        wrapperCol={{ span: 16 }}
                    ...
                    >
                        ...
                        <div className='flex justify-center gap-2 p-4'>
                            ...
                            <Link className="underline cursor-pointer" to='/login'>Sign in here</Link>
                        </div>
                    </Form>
                </div>
                <div className='max-lg:hidden'></div>
